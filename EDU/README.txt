...
This implementation is a reference with the following sensors: temperature, humidity, noise, air quality, water and camera. But any number of sensors can be easily inserted.
